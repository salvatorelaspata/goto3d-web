      ...
      <div className="w-full px-4">
        <div className="flex flex-col items-center relative">
          <div className="w-full  svelte-1l8159u">
            <div className="my-2 p-1 flex border border-gray-200 bg-palette3 rounded svelte-1l8159u">
          ...
          <div className="absolute shadow top-100 bg-palette3 z-40 w-full lef-0 rounded max-h-select overflow-y-auto svelte-5uyqqj">
