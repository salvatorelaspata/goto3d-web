...
**Ultimo aggiornamento**: 2026-03-01 (allineamento con sviluppi in corso)

## Stato di avanzamento

| # | Area | File | Priorita | Task | Completati | Parziali | Pendenti |
|---|------|------|----------|------|------------|----------|----------|
| 1 | [Sicurezza](./01-sicurezza.md) | `01-sicurezza.md` | P0-P1 | 7 | 0 | 2 | 5 |
| 2 | [Performance](./02-performance.md) | `02-performance.md` | P0-P2 | 6 | 0 | 0 | 6 |
| 3 | [Code Quality](./03-code-quality.md) | `03-code-quality.md` | P0-P2 | 6 | 0 | 2 | 4 |
| 4 | [Frontend & UX](./04-frontend.md) | `04-frontend.md` | P1-P3 | 7 | 0 | 0 | 7 |
| 5 | [Testing](./05-testing.md) | `05-testing.md` | P0-P3 | 4 | 0 | 0 | 4 |
| 6 | [Infrastruttura](./06-infrastruttura.md) | `06-infrastruttura.md` | P1-P3 | 6 | 0 | 0 | 6 |
...
- **BUG REACT**: hook condizionale in `ProjectCard.tsx` (`useEffect` dentro `if`) viola regole dei Hooks
- **Piani da aggiornare**: SEC-02, INFRA-05, TEST-04 referenziano `/api/send-to-queue` che non esiste piu
...
└── 06-infrastruttura: INFRA-03 (Supabase auth migration)

Fase 3 - Miglioramenti P2 (~8-10 giorni)
├── 02-performance: PERF-04 (lazy loading), PERF-05 (N+1 queries)
├── 03-code-quality: CQ-02 a CQ-05
├── 04-frontend: FE-02 (A11Y), FE-03 (SSR cleanup)
├── 05-testing: TEST-01 (fix Cypress), TEST-02 (expand E2E), TEST-03 (component tests)
└── 06-infrastruttura: INFRA-04 (PWA migration), INFRA-05 (API constants)
